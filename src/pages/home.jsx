...
//                         className="absolute inset-0 h-full w-full object-cover object-center brightness-[1.15] saturate-[1.1]"
//                     />
...
//                 <div className="relative z-10 flex min-h-[calc(100vh-80px)] items-center px-6 py-16 sm:px-10 lg:px-16 xl:px-20">
...
//                             <span className="h-[1px] w-12 bg-orange-400/70" />

//                             <p className="text-xs font-semibold tracking-[0.5em] text-white/70">
...
//                             <span className="block font-serif text-6xl font-bold tracking-wide text-[#f6b34b] drop-shadow-[0_0_18px_rgba(255,166,40,0.55)] sm:text-7xl md:text-8xl lg:text-8xl xl:text-9xl">
//                                 DANDIYA
//                             </span>

//                             <span className="mt-2 block font-serif text-5xl font-semibold tracking-wide text-white drop-shadow-[0_4px_12px_rgba(0,0,0,0.8)] sm:text-6xl md:text-7xl lg:text-7xl xl:text-8xl">
//                                 NIGHT 2026
//                             </span>
...
//                         <div className="mt-5 flex flex-wrap gap-3 text-base font-semibold text-[#f4b75c]">
...
//                             <Link
//                                 to="/passes"
//                                 className="group flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-yellow-400 px-7 py-4 font-bold text-black transition-all duration-300 hover:scale-105 hover:shadow-[0_0_35px_rgba(249,115,22,0.5)]"
//                             >
//                                 Book Your Ticket
...
//                             <Link
//                                 to="/shop"
//                                 className="flex items-center justify-center rounded-xl border border-orange-400/50 bg-black/30 px-7 py-4 font-bold text-orange-300 backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-orange-400 hover:text-black"
//                             >
//                                 Shop Dandiya 🪔
//                             </Link>
...
//                 <button
//                     onClick={prevSlide}
//                     className="absolute left-4 top-1/2 z-20 -translate-y-1/2 rounded-full border border-white/20 bg-black/40 p-3 text-white backdrop-blur-md transition hover:bg-orange-500 hover:text-black sm:left-6"
//                 >
//                     <ChevronLeft size={24} />
//                 </button>
...
//                 <button
//                     onClick={nextSlide}
//                     className="absolute right-4 top-1/2 z-20 -translate-y-1/2 rounded-full border border-white/20 bg-black/40 p-3 text-white backdrop-blur-md transition hover:bg-orange-500 hover:text-black sm:right-6"
//                 >
...
//             <section className="relative overflow-hidden bg-[#070707] px-6 py-20 sm:px-10 lg:px-16 xl:px-20">
...
//                         <h2 className="font-serif text-4xl font-bold text-white sm:text-5xl md:text-6xl">
...
//                             viewport={{ once: true }}
//                             whileHover={{ y: -10 }}
//                             className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.03] p-7 backdrop-blur-md transition-all duration-300 hover:border-orange-400/50"
//                         >
...
//                                 <div className="mb-6 flex h-14 w-14 items-center justify-center rounded-xl border border-orange-400/20 bg-orange-500/10 text-3xl transition duration-300 group-hover:scale-110">
//                                     🎵
//                                 </div>
...
//             <section className="relative overflow-hidden bg-[#050505] px-6 py-24 sm:px-10 lg:px-16 xl:px-20">
...
//                         <p className="mb-4 text-xs font-semibold tracking-[0.45em] text-orange-400 sm:text-sm">
//                             BOOK YOUR ENTRY
//                         </p>
...
//                     <div className="mx-auto mt-16 grid max-w-6xl gap-7 md:grid-cols-3">
...
//                             viewport={{ once: true }}
//                             whileHover={{ y: -10 }}
//                             className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#0c0c0c] p-8 transition duration-300 hover:border-orange-400/50"
//                         >
...
//                                 <div className="my-7 space-y-3 text-sm text-white/70">
...
//                                 <Link
//                                     to="/passes"
//                                     className="mt-7 flex w-full items-center justify-center rounded-xl border border-orange-400/40 py-3 font-semibold text-orange-300 transition duration-300 hover:bg-orange-400 hover:text-black"
//                                 >
//                                     Choose Pass
//                                 </Link>
...
//                             viewport={{ once: true }}
//                             whileHover={{ y: -12 }}
//                             className="group relative overflow-hidden rounded-3xl border border-orange-400/50 bg-gradient-to-b from-orange-500/10 to-[#0c0c0c] p-8 shadow-[0_0_50px_rgba(249,115,22,0.08)] transition duration-300 hover:border-orange-400"
//                         >

//                             {/* POPULAR BADGE */}

//                             <div className="absolute right-5 top-5 rounded-full bg-orange-400 px-3 py-1 text-xs font-bold text-black">
//                                 MOST POPULAR
//                             </div>
...
//                                 <div className="my-7 space-y-3 text-sm text-white/75">
...
//                                 <Link
//                                     to="/passes"
//                                     className="mt-7 flex w-full items-center justify-center rounded-xl bg-gradient-to-r from-orange-500 to-yellow-400 py-3 font-bold text-black transition duration-300 hover:scale-[1.03] hover:shadow-[0_0_25px_rgba(249,115,22,0.4)]"
//                                 >
//                                     Choose Pass
//                                 </Link>
