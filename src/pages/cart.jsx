...
//         >
//           <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-orange-500/10 text-orange-400">
...
//             Looks like you haven't added anything yet. Choose your event pass
//             or grab your Dandiya set and get ready for the celebration!
//           </p>

//           <Link
//             to="/passes"
//             className="mt-8 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-yellow-400 px-7 py-4 font-bold text-black transition hover:scale-105"
//           >
//             <ArrowLeft size={18} />
//             Explore Passes
//           </Link>
...
//   return (
//     <div className="min-h-screen bg-[#050505] px-5 py-14 text-white sm:px-10 lg:px-16">
...
//       <div className="mx-auto mt-12 grid max-w-7xl gap-10 lg:grid-cols-[1fr_380px]">
...
//               className="flex flex-col gap-5 rounded-2xl border border-white/10 bg-[#0b0b0b] p-5 sm:flex-row sm:items-center"
//             >

//               {/* ITEM ICON */}

//               <div className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-orange-500/10 text-4xl">
//                 {item.type === "pass"
//                   ? "🎟️"
//                   : item.emoji || "🪔"}
//               </div>
...
//                     className="flex h-9 w-9 items-center justify-center rounded-lg text-white/70 transition hover:bg-orange-500 hover:text-black"
//                   >
//                     <Minus size={17} />
//                   </button>
...
//                   className="flex items-center gap-2 text-sm text-red-400/80 transition hover:text-red-400"
//                 >
//                   <Trash2 size={17} />
//                   Remove
//                 </button>
...
//           <Link
//             to="/checkout"
//             className="group mt-8 flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-yellow-400 py-4 font-bold text-black transition-all duration-300 hover:scale-[1.02] hover:shadow-[0_0_30px_rgba(249,115,22,0.4)]"
//           >
//             Proceed to Checkout
...
//           <Link
//             to="/passes"
//             className="mt-5 flex items-center justify-center gap-2 text-sm text-white/50 transition hover:text-orange-400"
//           >
//             <ArrowLeft size={16} />
