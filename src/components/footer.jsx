...
//     return (
//         <footer className="border-t border-orange-500/20 bg-[#070707] text-white">
...
//                         <div>
//                             <h2 className="text-xl font-bold tracking-wide text-orange-400">
//                                 DANDIYA
//                             </h2>
...
//                         <a
//                             href="#"
//                             className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 text-white/60 transition-all duration-300 hover:-translate-y-1 hover:border-orange-400 hover:bg-orange-500 hover:text-black"
//                         >
//                             <Camera size={19} />
//                         </a>
...
//                                 key={link.name}
//                                 to={link.path}
//                                 className="group flex items-center gap-2 text-white/55 transition hover:text-orange-400"
//                             >
//                                 <ChevronRight
//                                     size={17}
...
//                     <Link
//                         to="/passes"
//                         className="mt-6 inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-orange-500 to-yellow-400 px-5 py-3 font-bold text-black transition-all duration-300 hover:scale-105 hover:shadow-[0_0_25px_rgba(249,115,22,0.4)]"
//                     >
//                         Book Your Pass
...
//                 <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-4 px-5 py-6 text-sm text-white/45 sm:flex-row sm:px-8 lg:px-10">
